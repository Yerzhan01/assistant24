...
async def whatsapp_webhook(
    ...
    try:
        ...
        # Offload processing to background task to prevent timeout (GreenAPI requires 200 OK within 180s)
        background_tasks.add_task(service.process_webhook, tenant_id, webhook_data)
