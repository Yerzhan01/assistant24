...
Шығару керек:
- action: "list" (барлық контактарды көрсету), "create" (қосу), "find" (іздеу), "delete" (жою), "stats" (санын білу)
- name: байланыс аты
...
Извлекай:
- action: "list" (показать ВСЕ), "create" (создать), "find" (найти ПО ИМЕНИ), "delete" (удалить), "stats" (статистика)

ВАЖНО: "Мои контакты" = {"action": "list"}, НЕ find!
- name: имя контакта
