...
class User(Base):
    ...
    morning_briefing_hour: Mapped[Optional[int]] = mapped_column(default=9)  # Hour for morning briefing (0-23)
    reminder_before_minutes: Mapped[int] = mapped_column(default=30)  # Minutes before meeting to remind
